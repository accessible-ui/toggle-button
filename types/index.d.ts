 ...
 */
export declare function useA11yToggleButton<T extends HTMLElement, E extends React.MouseEvent<T, MouseEvent>>(target: React.RefObject<T> | T | null, { active: controlledActive, defaultActive, onClick, onChange, }?: UseA11yToggleButtonOptions<E>): {
 ...
 */
export declare function ToggleButton({ active, defaultActive, activeClass, inactiveClass, activeStyle, inactiveStyle, onChange, children, }: ToggleButtonProps): React.ReactElement<any, string | ((props: any) => React.ReactElement<any, string | any | (new (props: any) => React.Component<any, any, any>)> | null) | (new (props: any) => React.Component<any, any, any>)>;
...
export interface UseA11yToggleButtonOptions<E extends React.MouseEvent<any, MouseEvent>> {
    /**
